...
- [ ] Create `apps/nextjs/src/app/data/certifications.json` with schema
...
- [ ] Create `apps/nextjs/src/app/data/documents.json`
...
- [ ] Create `packages/api/src/router/trust-center.ts` (or extend existing)
  - tRPC router for contact form: `contact.submit()`
  - tRPC router for document requests: `documents.request()`
  - Input validation with Zod schemas
- [ ] **Validation**: `pnpm typecheck` passes, schemas validate sample data
...
- [ ] Create `apps/nextjs/src/app/trust-center/_components/hero-section.tsx`
...
- [ ] Create `apps/nextjs/src/app/trust-center/_components/compliance-grid.tsx`
...
- [ ] Create `apps/nextjs/src/app/trust-center/_components/security-overview.tsx`
...
- [ ] Create `apps/nextjs/src/app/trust-center/_components/document-library.tsx`
...
- [ ] Create `document-request-form.tsx` (sub-component)
...
- [ ] Create `apps/nextjs/src/app/trust-center/_components/subprocessors-list.tsx`
...
- [ ] Create `apps/nextjs/src/app/trust-center/_components/faq-section.tsx`
...
- [ ] Create `apps/nextjs/src/app/trust-center/_components/contact-form.tsx`
...
- [ ] Create `apps/nextjs/src/app/trust-center/layout.tsx`
...
- [ ] Create `apps/nextjs/src/app/trust-center/page.tsx`
...
- [ ] Implement `contact.submit()` in `packages/api/src/router/trust-center.ts`
...
- [ ] Implement `documents.request()` in same router
